...
\begin{itemize}
    \item \textbf{Espiras de Sombra:} Cuya función y principio físico de desfasamiento se describen en la Sección~3.4 (ítem 7), fueron identificadas visualmente sobre el núcleo magnético fijo (Figura~\ref{fig:espiras_sombra}). Su propósito es mantener una fuerza de atracción mínima continua para evitar la vibración mecánica.
