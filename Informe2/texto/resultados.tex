...
Se utilizó una cinta métrica para medir las dimensiones del nucleo macizo, dichas dimensiones se presentan en la tabla \ref{Dimensiones del núcleo macizo}.
...
A contniuación se energizó el circuito y se tomaron las mediciones de voltaje, corriente y potencia en el lado primario del transformador para distintos valores de tensión, respetando siempre la corriente máxima que soportan las bobinas. La tabla \ref{tab:nucleo_macizo} muestra estas mediciones.
...
En la figura \ref{fig:ciclo_histeresis_macizo} se presenta el ciclo de histéresis visto en el osciloscopio para el núcleo macizo al conectar las puntas tal y como indica el diagrama de conexiones, Así mismo, la figura \ref{fig:formas_onda_macizo} muestra las formas de onda del voltaje y la corriente.
...
Para el nucleo laminado también se midieron sus dimensiones tal y como se muestra en el cuadro \ref{Dimensiones del núcleo laminado}.
...
Al igual que con el nucleo macizo se tomaron las mediciones de voltaje, corriente y potencia en el lado primario del transformador evitando superar la corriente máxima que soporta la bobina, obteniendo los resultados del cuadro \ref{tab:nucleo_laminado}.
...
A continuación se presenta el ciclo de histéresis visto en el osculoscopio para el núcleo laminado, seguido de las formas de onda de tensión y de corriente.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/ondas-nucleo-laminado.png}
\caption{Formas de onda de tensión y corriente para el núcleo laminado.}
\label{fig:ondas_nucleo_laminado}
\end{figure}
...
\end{itemize}
Es importante mencionar que en cuanto a las pérdidas por efecto Joule
en este informe no se calcularon para ninguno de los dos núcleos ya que las pérdidas 
en el cobre son despreciables en comparación con las pérdidas por histéresis y corrientes de Foucault,
entonces se asumió que $P_J \approx 0$ W para ambos núcleos. Por lo tanto, la potencia medida en el wattimetro es
practicamente igual a la potencia disipada en el núcleo.
