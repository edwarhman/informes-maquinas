...
\begin{document}
   ...
   \tableofcontents
    \newpage
    \input{texto/introduccion}
    %\input{texto/resumen}
    \input{texto/objetivos}
    \input{texto/marco teorico}
    %\input{texto/metodologia}
    \input{texto/Equipos e instrumentos}
    \input{texto/diagramas de conexiones}
    \input{texto/metodologia}
    \input{texto/resultados}
    \input{texto/analisis de resultados}
    \input{texto/conclusiones}
