...
\begin{itemize}
    ...
    \begin{equation}
        K_V = \frac{(4\,\text{V})(1\,\mu\text{F})(150k\Omega)}{(150\,\text{vueltas})(9,61\times 10^{-4}\,\text{m}^2)} = 4,16 [Tesla/div]
    \end{equation}
    ...
    \begin{equation}
        K_H = \frac{(300 vueltas)( 48 mV)}{(5 m\Omega)(0,3393 m)} = 8,488 k A/m.div
    \end{equation}

    \item Determinar las pérdidas por histéresis
    ...
    \begin{equation}
    W = 4 * K_V * K_H = 4 * 4,16 * 8,488 k = 141,3 W
    \end{equation}
...
Se sabe que la potencia consumida por la bobina se calcula:
\begin{equation}
    P_J = I_{\text{RMS}}^2 \cdot R
\end{equation}

Donde:
\begin{itemize}
    \item $I_{\text{RMS}}$ = 3,8 A
    \item R es la resistencia de la bobina, que se puede calcular a partir de:
\end{itemize}
...
\begin{itemize}
    ...
    \begin{equation}
            K_V = \frac{(100\,\text{mV})(1\,\mu\text{F})(150 \times 10^3\,\Omega)}{(150\,\text{vueltas})(9,0 \times 10^{-4}\,\text{m})} = 0,11 [Tesla/div]
    \end{equation}
    ...
    Lodes más valores son conocidos: \newline
    $N_1 = 300\ \text{ vueltas}$      \newline
    $V_s = 40\ \text{ mV}$            \newline
    $R_s = 5\ \text{ m}\Omega$         \newline
    $L = 0,328\ \text{ m}$            \newline
