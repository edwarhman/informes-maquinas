...
\begin{itemize}
    ...
    \begin{equation}
        R_s = \frac{V}{I} = \frac{50mV}{10A} = 5m\Omega
    \end{equation}
    ...
    \begin{equation}
            K_V = \frac{(1.8\,\text{mV})(1\,\mu\text{F})(150\times 10^{3}\Omega)}{(150\,\text{vueltas})(9,61\times 10^{-4}\,\text{m}^2)} = 1,873 m[Tesla/div]
    \end{equation}
         
    \item Determinar el factor de escala horizontal $K_H$
        \begin{equation}
            K_H = \frac{N_1V_s}{R_sL}
        \end{equation}
...
\begin{itemize}
    ...
    \begin{equation}
            K_V = \frac{(1.8\,\text{mV})(1\,\mu\text{F})(5\,\text{m}\Omega)}{(150\,\text{vueltas})(9,0\,\text{m}^4)} = 0,667 p[Tesla/div]
    \end{equation}
